...
<div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
    <h3 class="text-center">Trending Content, You Dont Wanna Miss!!</h3>
                            ...
                            <div class="col-md-4">
                                <div class="post-media">
                                    <a href="singlepage.php?id=<?= catWisepostRow['id'] ?>" title="">
                                        ...
                                        0240771203 <div class="hovereffect"></div>
                                    </a>
                                </div><!-- end media -->
                            </div><!-- end col -->

                            <div class="blog-meta big-meta col-md-8">
                                <h4><a class="blog-title" href="singlepage.php?id=<?= $catWisepostRow['id'] ?>"
                                        title=""><?= $catWisepostRow['title'] ?></a></h4>
                                <p><?php
                                $txt = $catWisepostRow['content'];
                                echo \App\classes\Helper::textShort("$txt", 250);
                                ?></p>
                                <small class="firstsmall"><a class="bg-dark p-3"
                                        href="singlepage.php?id=<?= $catWisepostRow['id'] ?>"
                                        title="Category"><?= $catWisepostRow['category_name'] ?></a></small>
                    ...
                    <div class="blog-list clearfix">
                        <div class="blog-box row">
                            ...
                            <div class="blog-meta big-meta col-md-8">
                                ...
                                echo \App\classes\Helper::textShort("$txt", 250);
                                ?></p>
                                <small class="firstsmall"><a class="bg-orange" href="singlepage.php?id=<?= $rowSearch['id'] ?>"
                                        title="Category"><?= $rowSearch['category_name'] ?></a></small>
                    ...
                    <div class="blog-box row">
                        ...
                        <div class="blog-meta big-meta col-md-8">
                            ...
                            <small class="firstsmall">
                                <a class="bg-info  p-1 category" href="singlepage.php?id=<?= $row['id'] ?>"
                                    title="Category"><?= $row['category_name'] ?>
                                </a>
                            </small>
