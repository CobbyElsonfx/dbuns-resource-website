...
<script>
 ...
 $(document).ready(function() {
    // Fetch data from Google Sheets and populate DataTable
    $.ajax({
        url: 'https://script.google.com/macros/s/AKfycbzy7iAsz8BvQMKe1wkySkAJPGK-Up21A3bY19pqUxOLchV1nLsB8JLbRGHanSrTVYrm/exec',
        type: 'GET',
        success: function(data) {
            ...
            var dataTableData = data.map(function(row) {
                return {
                    ...
                    'MOMO Number': row[1],
                    'MOMO Name': row[2],
                    'Last Four Digits': row[3],
                    'Package': row[4],
                    'Amount Paid': row[5],
                    'Action': '<button onclick="confirmOrder()">Confirm</button>'
                };
            });
            ...
            $('#ordersTable').DataTable({
                ...
                columns: [
                    ...
                    { title: 'MOMO Number', data: 'MOMO Number' },
                    { title: 'MOMO Name', data: 'MOMO Name' },
                    { title: 'Last Four Digits', data: 'Last Four Digits' },
                    { title: 'Package', data: 'Package' },
                    { title: 'Amount Paid', data: 'Amount Paid' },
  ...
  // Function to confirm order (you can implement your logic here)
